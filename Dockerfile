...
ENV SERVER_PORT=${SERVER_PORT} \
    ...
    APP_THUMBNAIL_DEFAULT_WIDTH=${APP_THUMBNAIL_DEFAULT_WIDTH} \
    APP_THUMBNAIL_DEFAULT_HEIGHT=${APP_THUMBNAIL_DEFAULT_HEIGHT} \
    APP_THUMBNAIL_DEFAULT_METHOD=${APP_THUMBNAIL_DEFAULT_METHOD} \
    APP_THUMBNAIL_DEFAULT_PERCENT=${APP_THUMBNAIL_DEFAULT_PERCENT} \
