...
ENV SERVER_PORT=${SERVER_PORT} \
    ...
    APP_POST_THUMBNAIL_WIDTH=${APP_POST_THUMBNAIL_WIDTH} \
    APP_POST_THUMBNAIL_HEIGHT=${APP_POST_THUMBNAIL_HEIGHT} \
    APP_POST_THUMBNAIL_METHOD=${APP_POST_THUMBNAIL_METHOD} \
    APP_POST_THUMBNAIL_PERCENT=${APP_POST_THUMBNAIL_PERCENT} \
